...
- [Firmware](https://github.com/by77er/beep_rs) programming & PCB design + electronics
- Toy operating systems and Linux kernel modules
- Minecraft server software contributions and [plugins](https://github.com/by77er/mcplug)

I used to have a homelab, but it had an unfortunate encounter with water (RIP).

I'm currently studying:
- LLM pretraining, inference, RL, and evaluation - particularly through an infra lens
- Pure mathematics
- Cooking
